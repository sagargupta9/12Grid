...
<body onload="hideSuccessMessage()">
        ...
        <div class="contact-form-container max-w-4xl w-full p-4">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="contact-form w-full">
                <?php if (isset($_SESSION['successMsg'])): ?>
                    <div id="successMessage" class="alert alert-success w-full text-center mb-2">
                        <?php 
            ...
            <div class="relative w-full h-full">
                ...
                <div class="absolute bottom-3 left-6 bg-blue-900 text-white p-6 rounded-lg shadow-lg max-w-sm">
                    ...
                    <a href="https://www.google.com/maps/place/Laser+Technologies+Pvt+Ltd/@19.1433969,73.0044389,791m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3be7bfeb4288ae8d:0x8b330290504e58fa!8m2!3d19.1433969!4d73.0070138!16s%2Fg%2F1tks4syy?entry=ttu&g_ep=EgoyMDI0MTExMi4wIKXMDSoASAFQAw%3D%3D" 
                        target="_blank" 
                        class="text-blue-200 underline text-sm">
                        Google Map Link
                </a>                
            </div>
            </div>
    ...
    <section class="container mt-5">
        ...
        <div class="row text-center">
            <div class="col-md-2">
                <div class="explore-card" style="background-image: url('images/Companies.JPEG');">
                    <p>Companies</p>
                </div>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <div class="explore-card" style="background-image: url('images/Webinars.jpeg');">
                    <p>Webinars</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="explore-card" style="background-image: url('images/Forums.jpeg');">
                    <p>Forums</p>
                </div>
            </div>
            <div class="col-md-2">
                <div class="explore-card" style="background-image: url('images/ApplicationNotes.jfif');">
